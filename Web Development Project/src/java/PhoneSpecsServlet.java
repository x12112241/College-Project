 ...
 * @author scr2
 */
@WebServlet(name="PhoneSpecsServlet", urlPatterns={"/PhoneSpecsServlet"})
public class PhoneSpecsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String XMLFileName = path + "/smartspecs.xml";
            String XSLFileName = path + "/phonespecs.xsl";
            ...
            // Get Navigation Info
            NodeList eventNodeList = doc.getElementsByTagName("smartphone");
